...
public class DES {
	 ...
	 * 
	 * @param content  鍐呭�?
	 * @param operation 鍔犲瘑鎴栬В�?��
	 * @param key 浣跨敤鍒扮殑瀵嗛�?:鍥哄畾闀垮害
	 * @return
	 */
	...
	public static void main(String[] args) {
		DES des = new DES();
		System.out.println(des.authcode("wewweewewew=","DECODE","0102030405060708"));//鍔犲�?
		System.out.println(des.authcode("d8fPhfd9JkW99p8aqhtVIA==","ENCODE","0102030405060708"));//瑙ｅ�?
	}
}